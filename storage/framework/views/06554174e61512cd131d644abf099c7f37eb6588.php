...
<li class="<?php echo (isset($title) && $title == 'Add New Institute')?'active':''; ?>"><a href="<?php echo e(route('add-new-question')); ?>">Add New</a></li>
<li class="<?php echo (isset($title) && $title == 'Manage Institute Category')?'active':''; ?>"><a href="<?php echo e(route('manageinstitutecategory')); ?>">Category</a></li>
</ul>
</li>
...
<li class="nav-item <?php echo (isset($title) && $title == 'Orders')?'active':''; ?>"><a href="<?php echo e(route('order')); ?>" class="nav-link"><i data-feather="shopping-cart"></i> <span>Orders</span></a></li>

...
<?php if(in_array('1',$view_data) || in_array('1',$delete_data) || in_array('1',$edit_data)){
    ...
    ?>
<li class="<?php echo (isset($title) && $title == 'Manage Institute')?'active':''; ?>"><a href="<?php echo e(route('manageinstitute')); ?>">Manage Institutes</a></li>
...
<li class="<?php echo (isset($title) && $title == 'Manage Product')?'active':''; ?>"><a href="<?php echo e(route('all-product')); ?>">Manage e-books</a></li>
<li class="<?php echo (isset($title) && $title == 'Add New Product')?'active':''; ?>"><a href="<?php echo e(route('add-new-product')); ?>">Add New</a></li>
<?php } 

...
<form method="post" action="<?php echo e(route('studyMaterialProccess')); ?>" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<div class="card-footer" style="padding: 0.75rem 1rem;">
<a href="<?php echo e(route('study-category')); ?>">+ Add New Category</a>
</div>
<?php } ?>
</div>
...
<?php echo $__env->make('Csadmin.Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php\xamp\htdocs\coachingzon\resources\views/Csadmin/Study/addNewStudy.blade.php ENDPATH**/ ?>
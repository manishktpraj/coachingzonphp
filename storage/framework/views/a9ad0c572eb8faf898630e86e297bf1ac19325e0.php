...
<div class="card-body">
<?php echo $__env->make('Csadmin.bulkaction', ['status' => 'FILTER_ORDER'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<a href="<?php echo e(route('order-detail',$order->trans_user_id )); ?>" class="btn btn-info btn-icon mg-r-5" title="Copy Listing" style="padding:0px 5px;"><i class="fas fa-copy" style="font-size:11px;"></i></a>
...
<ul class="pagination pagination-filled mg-b-0"><?php echo e($orderdata->links()); ?></ul>
</div>
</div>
</div>
</div>

...
<a href="<?php echo e(route('viewstudent',$students->student_id )); ?>" class="btn btn-info btn-icon mg-r-5" title="Assign Package" style="padding:0px 5px;"><i class="fas fa-copy" style="font-size:11px;"></i></a>
...
<?php echo $__env->make('Csadmin.Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php\xamp\htdocs\coachingzon\resources\views/Csadmin/Students/index.blade.php ENDPATH**/ ?>
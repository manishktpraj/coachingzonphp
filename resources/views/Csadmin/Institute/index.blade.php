...
<td>
    ...
    <a href="{{route('videoStatus',$video->video_id)}}"><span class="badge badge-success">Active</span></a>
    <?php }else{?>
    <a href="{{route('videoStatus',$video->video_id)}}"><span class="badge badge-danger">Inactive</span></a>
    <?php }?>
...
<a href="{{route('videoDelete',$video->video_id )}}" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-icon mg-r-5" title="Delete" style="padding:0px 5px;"><i class="fas fa-trash-alt" style="font-size:11px;"></i></a>
</nav>
</div>
</td>
</tr>    

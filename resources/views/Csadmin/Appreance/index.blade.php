...
<a href="{{route('add-new-slider')}}" class="btn btn-sm pd-x-15 btn-primary btn-uppercase  mg-l-5"><i data-feather="plus" class="wd-10 mg-r-5"></i>Add New Slider</a>
</div>
</div>
...
<!--<div class="card-body">
@include('Csadmin.bulkaction', ['status' => 'FILTER_VIDEO'])
...
<td>
    ...
    <a href="{{route('sliderStatus',$slider->slider_id)}}"><span class="badge badge-success">Active</span></a>
    <?php }else{?>
    <a href="{{route('sliderStatus',$slider->slider_id)}}"><span class="badge badge-danger">Inactive</span></a>
    <?php }?>
...
<a href="{{route('add-new-slider',$slider->slider_id )}}" class="btn btn-primary btn-icon mg-r-5" title="Edit" style="padding:0px 5px;"><i class="fas fa-pencil-alt" style="font-size:11px;"></i></a>
<a href="{{route('sliderDelete',$slider->slider_id )}}" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-icon mg-r-5" title="Delete" style="padding:0px 5px;"><i class="fas fa-trash-alt" style="font-size:11px;"></i></a>
</nav>
</div>
</td>
</tr>

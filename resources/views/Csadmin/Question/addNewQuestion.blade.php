			...
			<div class="col-lg-12">
				<div class="card mg-b-15">
					<div class="card-header d-flex align-items-center justify-content-between">
						<h6 class="mg-b-0" style="font-size: 1rem;font-weight: 600;">Question Entry Options</h6> </div>
					<div class="card-body">
						<div class="row row-xs">
							<div class="col-lg-4">
								<div class="form-group mg-b-0">
									...
									<select class="custom-select" name="category_parent" id="selected_sub">
										...
										<?php foreach($resSubData as $subject){ ?>
											<option value="<?php echo $subject->sc_id?>">
												<?php echo $subject->sc_name?>
											</option>
											<?php } ?>
									</select>
								</div>
							...
							<div class="col-lg-4">
								<div class="form-group mg-b-0">
									...
									<select class="custom-select multiple" name="category_parent" onchange="showDiv(this.value)">
				...
				<div class="card">
					<div class="card-header d-flex align-items-center justify-content-between">
						<h6 class="mg-b-0" style="font-size: 1rem;font-weight: 600;">Question Details</h6> </div>
					<div class="card-body">
						...
						<div class="form-group mg-b-0 category_show ">
							<label style="width:100%"> Correct Answer & Question Options:
								<div class="check-box-editior">Ʃ Text Editor
									<input type="checkbox" id="text_editor" onclick="seteditor($(this))">
								</div>
							</label>
							<div class="mc-question-box">
								<div class="mcq-q">
									...
									<div class="radio-box">
										<input name="tla_correct_option[]" required="required" value="0" type="radio">
									</div>
								</div>
								<div class="mcq-a">
							...
							<div class="mc-question-box">
								...
								<div class="mcq-a">
									<textarea class="form-control" name="tla_options_text[]" required="required" style="display: block;"> </textarea>
								</div> <a href="javascript:void(0);" class="mcq-d text-danger-600 remove_field" onclick="removecode($(this))" style="display: flex;border: 1px solid #c0ccda; align-items: center;justify-content: center;margin-left: 5px;color: #e53935;border-radius: 0.25rem; width:50px"><i class="fas fa-trash-alt" style="font-size:18px;"></i></a> </div>

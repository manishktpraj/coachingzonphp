...
<a href="{{route('exportQuestion')}}" class="btn btn-sm pd-x-15 btn-white btn-uppercase"><i data-feather="file" class="wd-10 mg-r-5"></i>Export</a>
<a href="{{route('importQuestion')}}" class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5"><i data-feather="file" class="wd-10 mg-r-5"></i>Import</a>
<a href="{{route('add-new-question')}}" class="btn btn-sm pd-x-15 btn-primary btn-uppercase  mg-l-5"><i data-feather="plus" class="wd-10 mg-r-5"></i>Add New Question</a>
</div>
</div>

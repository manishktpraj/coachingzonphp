...
<a href="{{route('addnewtest')}}" class="btn btn-sm pd-x-15 btn-primary btn-uppercase  mg-l-5"><i data-feather="plus" class="wd-10 mg-r-5"></i>Add New Test/Exams</a>
</div>
</div>
...
<div class="card-body">
@include('Csadmin.bulkaction', ['status' => 'FILTER_TEST'])
</div>
...
<td>
    ...
    <a href="{{route('testStatus',$test->test_id)}}"><span class="badge badge-success">Active</span></a>
    <?php }else{?>
    <a href="{{route('testStatus',$test->test_id)}}"><span class="badge badge-danger">Inactive</span></a>
    <?php }?>
</td>
...
<a href="{{route('testQuestion',$test->test_id )}}" class="btn btn-info btn-icon mg-r-5" title="Questiion" style="padding:0px 5px;"><i class="fas fa-copy" style="font-size:11px;"> +</i></a>

<a href="{{route('addnewtest',$test->test_id )}}" class="btn btn-primary btn-icon mg-r-5" title="Edit" style="padding:0px 5px;"><i class="fas fa-pencil-alt" style="font-size:11px;"></i></a>
<a href="{{route('testDelete',$test->test_id )}}" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-icon mg-r-5" title="Delete" style="padding:0px 5px;"><i class="fas fa-trash-alt" style="font-size:11px;"></i></a>
</nav>
</div>
</td>
</tr>    
...
<ul class="pagination pagination-filled mg-b-0">{{ $resTestData->links() }}</ul>
</div>
</div>
</div>
</div>

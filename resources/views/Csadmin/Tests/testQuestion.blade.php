...
<a href="{{route('addtestQuestion',$resTestData->test_id )}}" class="btn btn-info btn-icon mg-r-5" title="Questiion" style="padding:0px 5px;"><i class="fas fa-copy" style="font-size:11px;"> +</i></a>
</nav>
</div>
</td>
